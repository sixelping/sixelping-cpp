...
namespace sixelping::receiver::packets {
	...
	inline void
	process_packet_icmp_neighbor_sollicit(struct app_config *aconf, struct rte_mbuf *pkt, size_t offset, struct rte_ether_hdr *eth, struct rte_ipv6_hdr *ip,
	...
	inline void
	process_packet_icmp_echo_request(struct app_config *aconf, struct rte_mbuf *pkt, size_t offset, struct rte_ether_hdr *eth, struct rte_ipv6_hdr *ip,
	                                 struct icmp6_hdr *icmp) {
